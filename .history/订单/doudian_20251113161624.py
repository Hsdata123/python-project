...
def daliy_data_bash(df,live_room=['日期', '周', '月']):
    ...
    if "直播间" not in live_room:
        ...
        use_col = ['日期','周','月','直播间','店铺GMV(已加平台券)未扣退','扣退店铺成交(已加平台券)','总单数(已扣退)','客单价(已扣退)','扣退店铺成交(未加平台券)','退款金额占比','自播销售金额','自播销售占比','达播销售金额','达播销售占比','小店自卖销售金额','小店自卖销售占比','商品卡销售金额','商品卡销售占比','短视频销售金额','短视频销售占比','其他销售金额','其他销售占比']
