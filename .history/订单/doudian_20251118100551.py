...
if __name__ == "__main__":
    ...
    name_list = [{"name":"弹动官方旗舰店","data":"1763429494_01ee357474332516374d934fea6be03acSqUBCXQ.csv","live_room":"鱼子酱"}
                 ,{"name":"弹动个护旗舰店","data":"1763428837_9f3d00c37a3427f738c940c6135efe53NzkMwoHT.csv","live_room":"椰子"}
    ...
    live_time_gmv = qianchuan_group_merge(qianchuan_data,live_time_day_time_new)[["直播开始时间","整体成交金额","直播间"]]
    ...
    quanyu_live_data = quanyu_live_data[['直播间','直播开始时间','日期','直播间曝光-成交转化率(人数)','直播间曝光-观看率(人数)','直播间观看-商品曝光率(人数)','直播间商品曝光-点击率(人数)'
